...
@EthioUserBot.on_cmd("sudo", about={'header': "enable / disable sudo access"}, allow_channels=False)
...
@EthioUserBot.on_cmd("addsudo", about={
...
@EthioUserBot.on_cmd("delsudo", about={
...
@EthioUserBot.on_cmd("vsudo", about={'header': "view sudo users"}, allow_channels=False)
...
@EthioUserBot.on_cmd("addscmd", about={
...
@EthioUserBot.on_cmd("delscmd", about={
...
@EthioUserBot.on_cmd("vscmd", about={'header': "view sudo cmds"}, allow_channels=False)
